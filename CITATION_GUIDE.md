...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Alzheimer's Disease in Latin America 2000-2050: Prevalence, Projections and Dashboard. GitHub. https://github.com/juanmoisesd/alzheimer-latinamerica-dashboard
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Alzheimer's Disease in Latin America 2000-2050: Prevalence, Projections and Dashboard." GitHub. https://github.com/juanmoisesd/alzheimer-latinamerica-dashboard.
```

### BibTeX
```bibtex
@misc{delaserna2026_alzheimerlat,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Alzheimer's Disease in Latin America 2000-2050: Prevalence, Projections and Dashboard},
  year         = {2026},
...
TI  - Alzheimer's Disease in Latin America 2000-2050: Prevalence, Projections and Dashboard
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/alzheimer-latinamerica-dashboard
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Alzheimer's Disease in Latin America 2000-2050: Prevalence, Projections and Dashboard. GitHub; 2026. Available: https://github.com/juanmoisesd/alzheimer-latinamerica-dashboard. ORCID: 0000-0002-8401-8018.
```
